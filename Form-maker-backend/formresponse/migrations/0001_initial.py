# Generated by Django 3.1.5 on 2021-02-27 11:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('options_answer_selected', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(blank=True, max_length=10), size=1)),
                ('form_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='formmaker.formcreated')),
